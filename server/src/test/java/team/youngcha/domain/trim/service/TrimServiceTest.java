...
class TrimServiceTest {
    ...
    void extractTrimDetails() {
        ...
        carDetails.add(new CarDetails(2L, "Le Blanc (르블랑)", "leblancImg.png", "leblancBgImgWeb.png", "leblancBgImgAndroid.png", "베스트셀러", 40440000, "모두가 선택한 베스트셀러", 2, "베젤리스 인사이드 미러", "내관", 1, "insidemirror_s.jpg"));
        carDetails.add(new CarDetails(2L, "Le Blanc (르블랑)", "leblancImg.png", "leblancBgImgWeb.png", "leblancBgImgAndroid.png", "베스트셀러", 40440000, "모두가 선택한 베스트셀러", 2, "내비게이션 기반 스마트 크루즈 컨트롤 (안전구간, 곡선로)", "지능형 안전기술", 1, "ncss_s.jpg"));
        carDetails.add(new CarDetails(2L, "Le Blanc (르블랑)", "leblancImg.png", "leblancBgImgWeb.png", "leblancBgImgAndroid.png", "베스트셀러", 40440000, "모두가 선택한 베스트셀러", 2, "12.3인치 내비게이션(블루링크, 폰 프로젝션, 현대 카페이)", "멀티미디어", 1, "12.3navi_s.jpg"));
        carDetails.add(new CarDetails(2L, "Le Blanc (르블랑)", "leblancImg.png", "leblancBgImgWeb.png", "leblancBgImgAndroid.png", "베스트셀러", 40440000, "모두가 선택한 베스트셀러", 1, "쿨그레이 ", "내장 색상", 1, "colorchip-interior.png"));
        carDetails.add(new CarDetails(2L, "Le Blanc (르블랑)", "leblancImg.png", "leblancBgImgWeb.png", "leblancBgImgAndroid.png", "베스트셀러", 40440000, "모두가 선택한 베스트셀러", 1, "크리미 화이트 펄", "외장 색상", 1, "colorchip-exterior.png"));
        carDetails.add(new CarDetails(2L, "Le Blanc (르블랑)", "leblancImg.png", "leblancBgImgWeb.png", "leblancBgImgAndroid.png", "베스트셀러", 40440000, "모두가 선택한 베스트셀러", 1, "그라파이트 그레이 메탈릭", "외장 색상", 1, "colorchip-exterior.png"));
        carDetails.add(new CarDetails(5L, "Guide Mode", "guideModeImg.png", "guideModeBgImg.png", "guideModeBgImg.png", null, 38960000, null, null, null, null, null, null));
        ...
        softAssertions.assertThat(leblancTrimDetail.getBackgroundImgUrl().getWeb()).isEqualTo("leblancBgImgWeb.png");
        softAssertions.assertThat(leblancTrimDetail.getBackgroundImgUrl().getAndroid()).isEqualTo("leblancBgImgAndroid.png");
