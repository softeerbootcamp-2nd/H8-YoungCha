...
class OptionRepositoryTest {
    ...
    void findPowerTrain() {
        ...
        jdbcTemplate.update("insert into options (id, name, price, feedback_title, feedback_description, category_id) " +
                "values (1,'디젤', 1000, '좋아요', '좋아요 내용', 1)," +
                "(2,'가솔린', 2000, '추천', '추천 내용', 1)," +
                "(3,'mock', 0, 'mock', 'mock', 1)");
        ...
        Option diesel = Option.builder()
                ...
                .feedbackTitle("좋아요").feedbackDescription("좋아요 내용")
                .categoryId(1L)
                .build();
        Option gasoline = Option.builder()
                .id(2L).name("가솔린").price(2000)
                .feedbackTitle("추천").feedbackDescription("추천 내용")
                .categoryId(1L)
                .build();
