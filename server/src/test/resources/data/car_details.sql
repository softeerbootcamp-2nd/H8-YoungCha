...
VALUES (2, 'Le Blanc (르블랑)', 'leblancImgUrl', 'leblancBgImgUrlWeb', 'leblancBgImgUrlAndroid', '베스트셀러', 40440000, '모두가 선택한 베스트셀러', 1),
       (5, 'Guide Mode', 'guideModeImgUrl', 'guideModeBgImgUrlWeb', 'guideModeBgImgUrlAndroid', '나만을 위한 팰리세이드', 38960000, null, 1);
